  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="mx-auto mt-12 flex min-h-[26rem] max-w-2xl flex-col items-center justify-center rounded-3xl border border-border/80 bg-card/72 px-8 py-14 text-center shadow-[0_24px_70px_rgb(120_120_140_/_0.08)] sm:mt-14 sm:min-h-[32rem] sm:px-12">
          ...
          <div className="mt-10 inline-flex items-center gap-3 rounded-2xl border border-border bg-background/60 px-8 py-5 font-mono text-base text-primary shadow-[0_12px_30px_rgb(120_120_140_/_0.06)] sm:text-lg">
